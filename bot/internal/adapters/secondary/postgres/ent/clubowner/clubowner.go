...
const (
	// Label holds the string label denoting the clubowner type in the database.
	Label = "club_owner"
	...
	EdgeClub = "club"
	// Table holds the table name of the clubowner in the database.
	Table = "club_owners"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "club_owners"
...
// Columns holds all SQL columns for clubowner fields.
var Columns = []string{
	FieldID,
	FieldDeletedAt,
	FieldCreatedAt,
...
var (
	...
	DefaultWarnings bool
	// DefaultID holds the default value on creation for the "id" field.
	DefaultID func() uuid.UUID
)

// OrderOption defines the ordering options for the ClubOwner queries.
...
// ByWarnings orders the results by the warnings field.
func ByWarnings(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldWarnings, opts...).ToFunc()
}
