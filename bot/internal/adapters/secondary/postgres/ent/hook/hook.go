...
// The ClubOwnerFunc type is an adapter to allow the use of ordinary
// function as ClubOwner mutator.
type ClubOwnerFunc func(context.Context, *ent.ClubOwnerMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ClubOwnerFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ClubOwnerMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ClubOwnerMutation", m)
}
...
// The IgnoreMailingFunc type is an adapter to allow the use of ordinary
// function as IgnoreMailing mutator.
type IgnoreMailingFunc func(context.Context, *ent.IgnoreMailingMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f IgnoreMailingFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.IgnoreMailingMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.IgnoreMailingMutation", m)
}
