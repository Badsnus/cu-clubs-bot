...
func (s *UserRepository) Create(ctx context.Context, user *entity.User) (*entity.User, error) {
	err := s.db.WithContext(ctx).Create(&user).Error
	return user, err
}

// Get is a function that gets a user from the database by id.
func (s *UserRepository) Get(ctx context.Context, id uint) (*entity.User, error) {
...
func (s *UserRepository) GetUserByID(ctx context.Context, userID int64) (*entity.User, error) {
	var user entity.User
...
func (s *UserRepository) GetByQRCodeID(ctx context.Context, qrCodeID string) (*entity.User, error) {
	var user entity.User
	err := s.db.WithContext(ctx).Where("qr_code_id = ?", qrCodeID).First(&user).Error
	return &user, err
}

func (s *UserRepository) GetMany(ctx context.Context, ids []int64) ([]entity.User, error) {
	var users []entity.User
	err := s.db.WithContext(ctx).Where("id IN ?", ids).Find(&users).Error
	return users, err
}

func (s *UserRepository) GetByEmail(ctx context.Context, email valueobject.Email) (*entity.User, error) {
	var user entity.User
	err := s.db.WithContext(ctx).Where("email = ?", email.String()).First(&user).Error
	return &user, err
}
...
func (s *UserRepository) GetEventUsers(ctx context.Context, eventID string) ([]dto.EventUser, error) {
...
func (s *UserRepository) GetUsersByEventID(ctx context.Context, eventID string) ([]entity.User, error) {
	var users []entity.User
...
func (s *UserRepository) GetUsersByClubID(ctx context.Context, clubID string) ([]entity.User, error) {
	var users []entity.User
...
func (s *UserRepository) GetManyUsersByEventIDs(ctx context.Context, eventIDs []string) ([]entity.User, error) {
	var users []entity.User
...
func (s *UserRepository) Update(ctx context.Context, user *entity.User) (*entity.User, error) {
...
func (s *UserRepository) GetWithPagination(ctx context.Context, limit, offset int, order string) ([]entity.User, error) {
	var users []entity.User
...
func (s *UserRepository) IgnoreMailing(ctx context.Context, userID int64, clubID string) (bool, error) {
	var user *entity.User
