...
func (s *PassRepository) CreatePass(ctx context.Context, pass *entity.Pass) (*entity.Pass, error) {
	err := s.db.WithContext(ctx).Create(pass).Error
	return pass, err
}

// GetPass is a function that gets a pass from the database by id.
func (s *PassRepository) GetPass(ctx context.Context, id string) (*entity.Pass, error) {
...
func (s *PassRepository) UpdatePass(ctx context.Context, pass *entity.Pass) (*entity.Pass, error) {
	err := s.db.WithContext(ctx).Save(pass).Error
	return pass, err
}

// GetPassesByEventID is a function that gets passes by event id.
func (s *PassRepository) GetPassesByEventID(ctx context.Context, eventID string) ([]entity.Pass, error) {
...
func (s *PassRepository) GetPassesByUserID(ctx context.Context, userID int64, limit, offset int) ([]entity.Pass, error) {
	var passes []entity.Pass
...
func (s *PassRepository) GetPendingPassesForSchedule(ctx context.Context, before time.Time) ([]entity.Pass, error) {
	var passes []entity.Pass
...
func (s *PassRepository) MarkPassAsSent(ctx context.Context, id string, sentAt time.Time, emailSent, telegramSent bool) error {
...
func (s *PassRepository) MarkPassesAsSent(ctx context.Context, ids []string, sentAt time.Time, emailSent, telegramSent bool) error {
...
func (s *PassRepository) CreateBulkPasses(ctx context.Context, passes []entity.Pass) error {
...
func (s *PassRepository) GetActivePassForUser(ctx context.Context, eventID string, userID int64) (*entity.Pass, error) {
	var pass entity.Pass
...
func (s *PassRepository) HasActivePass(ctx context.Context, eventID string, userID int64) (bool, error) {
	var count int64
...
func (s *PassRepository) CancelPassesByEventAndUser(ctx context.Context, eventID string, userID int64) error {
...
func (s *PassRepository) GetPassesByRequester(ctx context.Context, requesterType entity.PassRequesterType, requesterID string, limit, offset int) ([]entity.Pass, error) {
	var passes []entity.Pass
...
func (s *PassRepository) CountPassesByRequester(ctx context.Context, requesterType entity.PassRequesterType, requesterID string) (int64, error) {
	var count int64
...
func (s *PassRepository) GetPassesByEventAndRequester(ctx context.Context, eventID string, requesterType entity.PassRequesterType, requesterID string) ([]entity.Pass, error) {
	var passes []entity.Pass
